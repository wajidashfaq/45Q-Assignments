...
let guestslist = ["Asher", "Rehamn", "Manto"];
...
console.log(guestslist);
// now we use 'push' method to add one more person in the last of the array
guestslist.push("M.Ahmed");
console.log(guestslist);
// now we send invitation to all by using 'forEach' method
